...
## FASE 1: PROJECT SETUP & INFRASTRUKTUR
...
## FASE 2: TIER 1 — GOOGLE APPS SCRIPT (LITE)
...
## FASE 3: TIER 2 — BACKEND NODE.JS (NESTJS)
...
| T2B-12 | POST /auth/login-wa (OTP via WAHA) | 🟡 P1 | ⬜ | T2B-11, T2B-WAHA | 3 jam |
...
## FASE 4: TIER 2 — FRONTEND REACT/VITE PWA
...
|--------|-------|----------|
| T1A: Auth & Akun | 10 | 0/10 |
| T1B: Dashboard | 6 | 0/6 |
| T1C: Transaksi / Kasir | 12 | 0/12 |
| T1D: Pengeluaran | 3 | 0/3 |
| T1E: Laporan | 6 | 0/6 |
| T1F: Notifikasi WA | 3 | 0/3 |
| T1G: Deploy & Test | 4 | 0/4 |
| **Total Tier 1** | **44** | **0/44** |

### Tier 2: Backend Node.js
| Module | Tasks | Complete |
|--------|-------|----------|
| T2B-01: Scaffolding | 8 | 0/8 |
| T2B-02: Auth | 7 | 0/7 |
| T2B-03: Products & Tiering | 6 | 0/6 |
| T2B-04: POS | 6 | 0/6 |
| T2B-05: Cashdrawer | 5 | 0/5 |
| T2B-06: Hutang/Piutang | 7 | 0/7 |
| T2B-07: Marketing | 6 | 0/6 |
| T2B-08: Attendance | 5 | 0/5 |
| T2B-09: Storefront | 6 | 0/6 |
| T2B-10: Reports | 6 | 0/6 |
| **Total Backend** | **62** | **0/62** |

### Tier 2: Frontend React
| Module | Tasks | Complete |
|--------|-------|----------|
| T2F-01: Scaffolding | 6 | 0/6 |
| T2F-02: Shared Components | 7 | 0/7 |
| T2F-03: Admin Pages | 11 | 0/11 |
| T2F-04: Storefront | 8 | 0/8 |
| **Total Frontend** | **32** | **0/32** |
...
| **Tier 1 (GAS)** | **44** | **0** |
| **Tier 2 Backend** | **62** | **0** |
| **Tier 2 Frontend** | **32** | **0** |
| **Integration & Other** | **34** | **0** |
| **GRAND TOTAL** | **172** | **0/172** |
...
**Update status:**
```
Cari ID task → ganti ⬜ menjadi ✅ / 🔄 / ⏸️
```

**Contoh workflow harian:**
1. Baca TODO.md
2. Pilih task 🔴 P0 yang ⬜
3. Update status → 🔄
4. Kerjakan task
5. Commit message: "feat: selesaikan [T1C-03] addTransaksi + LockService"
6. Update status → ✅

---

*Dokumen ini adalah master task list untuk pengembangan WarungDigital.*  
*Update: 14 Juli 2026*
